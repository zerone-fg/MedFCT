...
parser.add_argument('--exp', type=str,
                    default='ISIC/MedFCT', help='experiment_name')
parser.add_argument('--model', type=str,
                    default='MedFCT', help='model_name')
...
def train(args, snapshot_path):
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            loss = supervised_loss + consistency_weight * consistency_loss + loss_hint * 0.5 + unsupervised_loss + loss_cls * 10
            optimizer.zero_grad()
            loss.backward()
            optimizer.step()
