...
class DualBranch(nn.Module):
    def __init__(self, img_size=224, patch_size=4, in_chans=3, num_classes=1000,
        ...
        self.fusion_module.append(FDCF(64, 96, 56, 56, 56, 56))
        self.fusion_module.append(FDCF(128, 192, 28, 28, 28, 28))
        self.fusion_module.append(FDCF(256, 384, 14, 14, 14, 14))
...
class MedFCT(nn.Module):
    def __init__(self, classes, config):
        super(MedFCT, self).__init__()
